...
### 📊 Landing Page  
Login or Register to enter in the Website. 
![Stats Page](demo/img/LandingPage.PNG)

### 📊 Job Statistics Overview  
Monitor the status of your job applications. 
![Stats Page](demo/img/Stats.PNG)

### 🔍 Browse & Search Jobs  
View your entire job list with search filters and pagination.
![All Jobs Page](demo/img/AllJobs.PNG)

### ➕ Add New Jobs  
Submit job entries quickly using a simple input form.
![Add Job Page](demo/img/AddJob.PNG)
